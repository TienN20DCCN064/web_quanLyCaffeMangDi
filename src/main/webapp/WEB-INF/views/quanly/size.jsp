			...
			<div class="container-fluid px-4">
				<div class="card-header">
					<label class="font-weight-bold"
						style="font-size: 20px; color: #800000">QUẢN LÝ SIZE</label>
				</div>
				<div class="card-header">
					<form:form class="row g-3" modelAttribute="tk"
						...
						<div class='parent' class="col-md-2">
							...
							<div class='child float-left-child' style="margin-left: 2.5em">
								...
								<button
									onclick="location.href='http://localhost:8080/Highlands/account/list.htm'"
				...
				<div class="card mb-4">
					<div class="card-header">
						<i class="fas fa-table me-1"></i> DANH SÁCH CÁC SIZE MÓN
					</div>
					<div class="card-body">
							...
							<tbody>
								<c:forEach var="sz" items="${size}">
									<tr>
										...
										<td>${sz.TENSIZE}</td>
										<td><a
											href="/Highlands/account/list/${sz.MASIZE}.htm?linkEdit"
											rel="stylesheet"><img width="31" height="31"
												src="<c:url value='/resources/img/edit.png'/>" /></a></td>
										<td><a name="btnDelete"
											href="/Highlands/account/list/${sz.MASIZE}.htm?linkDelete"
