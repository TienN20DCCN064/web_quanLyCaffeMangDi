				...
				<div class="card-header">
					<form:form class="row g-3" modelAttribute="nguyenlieu"
						...
						<div class="col-md-4">
							...
							<form:select path="pk.NGUYENLIEU.MANL" items="${cacnguyenlieu}" itemValue="MANL" itemLabel="TENNL"  class="form-control"
								id="exampleFormControlInput1"/>
						</div>
						<div class="col-md-4">
							<label class="font-weight-bold">Số lượng</label>
							<form:input path="SOLUONG" type="number" step='0.01' placeholder='0.00' class="form-control"
								id="exampleFormControlInput1" />
