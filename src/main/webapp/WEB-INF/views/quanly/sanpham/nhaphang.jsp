...
<body class="sb-nav-fixed">
	...
	<c:if test="${quyennhap eq 'QL'}">
		<%@ include file="/WEB-INF/common/nhanvien/header.jsp"%>
	</c:if>
	<c:if test="${quyennhap eq 'NV'}">
		<%@ include file="/WEB-INF/common/nhanvien/header2.jsp"%>
	</c:if>
	<div id="layoutSidenav_content">
		<main>
			<div class="container-fluid px-4">
				...
				<div class="card mb-4">
					<div class="card-header">
						<i class="fas fa-table me-1"></i> DANH SÁCH NGUYÊN LIỆU NHẬP
					</div>
					<div class="card-body">
