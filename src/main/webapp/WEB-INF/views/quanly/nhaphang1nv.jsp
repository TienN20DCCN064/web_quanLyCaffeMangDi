			...
			<div class="container-fluid px-4">
				<div class="card-header">
					<label class="font-weight-bold"
						style="font-size: 20px; color: #800000">Nhân Viên Nhập
						Hàng</label>
				</div>
				<div class="card-header">
					<form class="row g-3"
				...
				<div class="card mb-4">
					<div class="card-header">
						<i class="fas fa-table me-1"></i> CHI TIẾT PHIẾU NHẬP1
					</div>
					<div class="card-body">
						<table id="datatablesSimple">
							<thead>
								<tr>
									<th style="text-align: center;">Mã Nhập Hàng1</th>
							...
							<tfoot>
								<tr>
									<th style="text-align: center;">Mã Nhập Hàng</th>
									<th style="text-align: center;">Họ Tên</th>
									<th style="text-align: center;">Ngày Nhập</th>
								</tr>
							</tfoot>
