			...
			<div class="container-fluid px-4">
				<div class="card-header">
					<label class="font-weight-bold"
						style="font-size: 20px; color: #800000">QUẢN LÝ NGUYÊN
						LIỆU</label>
				</div>
				<div class="card-header">
					<form:form class="row g-3" modelAttribute="nguyenlieu"
						...
						<div class="col-md-4">
							...
							<form:input path="SLTON" type="number" step='0.01'
				...
				<div class="card mb-4">
					...
					<div class="card-body">
						<table id="datatablesSimple">
							<thead>
								<tr>
									<th style="text-align: center;">Mã nguyên liệu</th>
							...
							<tbody>
								<c:forEach var="nguyenlieu" items="${dsnguyenlieu}">
									<tr>
										...
										<td>${nguyenlieu.SLTON}${nguyenlieu.DONVI}</td>
										<td><a
