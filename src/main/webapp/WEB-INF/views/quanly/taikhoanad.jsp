			...
			<div class="container-fluid px-4">
				<div class="card-header">
					<label class="font-weight-bold"
						style="font-size: 20px; color: #800000">QUẢN LÝ TÀI KHOẢN ad</label>
				</div>
						...
						<c:if test="${btnStatus=='btnEdit'}">
							...
							<div class="col-md-2">
								...
								<form:select disabled="true" path="QUYEN.MAQUYEN" items="${aus}"
									item="" itemValue="MAQUYEN" readonly="true"
									itemLabel="TENCV" class="form-control"
									aria-label=".form-select-lg example">
								</form:select>
							</div>
							<div class="col-md-2">
				...
				<div class="card mb-4">
					...
					<div class="card-body">
						<table id="datatablesSimple">
							<thead>
								<tr>
									<th>Tên Đăng Nhập (trang taikhoanad)</th>
									<th>Quyền</th>
									<th>Trạng Thái</th>
									<th>Sửa</th>
