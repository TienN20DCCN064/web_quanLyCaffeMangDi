				...
				<div class="card-header">
					<form:form class="row g-3" modelAttribute="chitiet"
						...
						<div class="col-md-4">
							...
							<form:select path="pk.SANPHAM.MASP" items="${cacsanpham}" itemValue="MASP" itemLabel="TENSP"  class="form-control"
								id="exampleFormControlInput1"/>
						</div>
						<div class="col-md-4">
							<label class="font-weight-bold">Size</label>
							<form:select path="pk.SIZE.MASIZE" items="${cacsize}" itemValue="MASIZE" itemLabel="TENSIZE"  class="form-control"
								id="exampleFormControlInput1" />
						</div>
						<div class="col-md-4">
