			...
			<div class="container-fluid px-4">
				<div class="card-header">
					<label class="font-weight-bold"
						style="font-size: 20px; color: #800000">Nhân Viên _ Chi
						Tiết Nhập Hàng</label>
				</div>
				<div class="card-header">
					<form class="row g-3"
						...
						<div class='parent' class="col-md-2">
							<div class='child float-left-child' style="margin-left: 2.5em">
								...
								<button
									...
									class="btn btn-warning" type="button">Hủy Nhập Hàng1</button>
				...
				<div class="card mb-4">
					<div class="card-header">
						<i class="fas fa-table me-1"></i> DANH SÁCH NGUYÊN LIỆU NHẬP nhaphangnv.jsp
					</div>
					<div class="card-body">
